# DIVIDE EL DATASET EN TRAIN Y TEST SETS, HACE PREDICCIONES USANDO REGRESIÓN LINEAL MÚLTIPLE, CALCULA EL MSE Y R2 Y GRAFICA EL RESULTADO.
...
for i, var in enumerate(independent_vars):
    ...
    y_pred_train_var = model.predict(x_train[[var]])
    y_pred_test_var = model.predict(x_test[[var]])

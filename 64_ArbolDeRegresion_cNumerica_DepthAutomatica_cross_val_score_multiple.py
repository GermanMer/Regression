...
for depth in max_depths:
    ...
    scores = cross_val_score(regression_tree, x_train, y_train, cv=5, scoring='neg_mean_squared_error')
...
# Entrena el árbol de regresión con la profundidad óptima en el conjunto de entrenamiento
...
# Calcula y muestra métricas de rendimiento en el conjunto de prueba

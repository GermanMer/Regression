...
x = df[['fuel-type', 'aspiration', 'make']]  # Usamos características categóricas
y = df['price']
...
x_test = pd.DataFrame({'fuel_gas': [1], 'fuel_diesel': [0], 'aspiration_std': [1], 'aspiration_turbo': [0], 'make_audi': [0], 'make_bmw': [1], 'make_chevrolet': [0], 'make_dodge': [0], 'make_honda': [0], 'make_jaguar': [0], 'make_mazda': [0],
